...
import br.com.j11.cagadas.application.service.GumGaleraService;
...
@RestController
@RequestMapping("/api/gumgalera")
public class GumGaleraAPI extends GumgaAPI<GumGalera, Long> {


    @Autowired
    public GumGaleraAPI(GumgaService<GumGalera, Long> service) {
        super(service);
    }
